...
| ---------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 2026-08-22 | Kód pod Apache 2.0, data pod CC BY-SA 4.0                                                                                    | Repozitář byl veřejný bez licence, tedy fakticky „všechna práva vyhrazena" — vypadal otevřeně a nebyl. Apache u kódu kvůli převzetí jinými městy, CC BY-SA u dat kvůli tomu, aby zůstala otevřená |
| 2026-08-22 | Plné texty programů stran zůstávají ve veřejném repozitáři (sekce B)                                                        | Rozhodnuto vědomě, ne mlčky pushem. Jde o dokumenty určené k veřejné distribuci; provenience u každého drží vydavatele i licenci |
